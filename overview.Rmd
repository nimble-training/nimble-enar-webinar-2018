...
Please ask questions and make comments as we go through the material via the online question or chat feature in the webinar. One of my colleagues, Nick Michaud, can answer them while I am talking. We will also have a shared document (Etherpad) at [https://v.etherpad.org/p/nimble-enar-2018](https://v.etherpad.org/p/nimble-enar-2018) where you can more easily post longer code snippets or error messages.
...
```
library(devtools)
install_github('nimble-dev/nimble', ref = 'BNP')
```
